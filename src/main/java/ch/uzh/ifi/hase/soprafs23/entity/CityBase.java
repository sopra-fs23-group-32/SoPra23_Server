...
public class CityBase {
    ...
    private void loadCityList() {
        ...
        if(category == CityCategory.EUROPE){
            City paris = new City("Paris", "France", "N48 E2");
            City berlin = new City("Berlin", "Germany", "N52 E13");
            City zurich = new City("Zurich", "Switzerland", "N47 E8");
            City london = new City("London", "UnitedKingdom", "N51 E0");
            City geneve = new City("Geneve", "Switzerland", "N46 E6");
